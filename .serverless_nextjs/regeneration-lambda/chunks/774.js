...
;// CONCATENATED MODULE: ./src/order/components/AddressList.tsx
...
function AddressList() {
    ...
    return /*#__PURE__*/ _jsxs(Wrapper, {
        children: [
            ...
            /*#__PURE__*/ _jsxs(AddressWrapper, {
                children: [
                    /*#__PURE__*/ _jsx("div", {
                        children: "대구 중구 남산로 4길 40-19"
                    }),
                    /*#__PURE__*/ _jsxs("div", {
                        children: [
                            /*#__PURE__*/ _jsx("span", {
            ...
            /*#__PURE__*/ _jsx(AddAddressButton, {
                onClick: ()=>{
...
const Wrapper = emotion_styled_esm/* default.div */.Z.div`
  width: 200px;
`;
const TopNavigator = emotion_styled_esm/* default.div */.Z.div`
  display: flex;
  justify-content: space-between;
`;
const AddressWrapper = emotion_styled_esm/* default.div */.Z.div`
  border: 1px solid black;
`;
const AddAddressButton = emotion_styled_esm/* default.div */.Z.div``;
...
function PaymentButton({ userInfo , orderList , isCheckSelfReceving , address  }) {
    ...
    return /*#__PURE__*/ (0,emotion_react_jsx_runtime_esm/* jsxs */.BX)(PaymentButton_Wrapper, {
        children: [
...
const PaymentButton_Wrapper = emotion_styled_esm/* default.div */.Z.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  padding: 0 20px;
...
function UserInfo({ userInfo , setIsCheckSelfReceving  }) {
    ...
    return /*#__PURE__*/ (0,emotion_react_jsx_runtime_esm/* jsxs */.BX)(emotion_react_jsx_runtime_esm/* Fragment */.HY, {
        children: [
            /*#__PURE__*/ (0,emotion_react_jsx_runtime_esm/* jsxs */.BX)(UserInfo_Wrapper, {
                children: [
                    /*#__PURE__*/ emotion_react_jsx_runtime_esm/* jsx */.tZ(dist/* Text */.xv, {
                        size: "lg",
                        weight: "semibold",
...
function OrderItemsSection({ data , initialVisible =false  }) {
    ...
    return /*#__PURE__*/ (0,emotion_react_jsx_runtime_esm/* jsxs */.BX)(OrderItemsSection_Wrapper, {
        children: [
            /*#__PURE__*/ (0,emotion_react_jsx_runtime_esm/* jsxs */.BX)(OrderListWrapper, {
                children: [
